...
async function exportExcel(rows, t, filename = 'EasyRent_Report') {
    ...
    ws.columns = [
        ...
        { header: t('finances.form.payment_date') || t('finances.form.paymentDate'), key: 'payment_date', width: 16 },
        { header: t('finances.form.period_month') || t('finances.form.periodMonth'), key: 'period_month', width: 12 },
...
async function exportPDF(rows, filters, t, language, formatCurrency, filename = 'EasyRent_Report') {
    ...
    autoTable(doc, {
        ...
        head: [[
            ...
            t('common.status'), t('finances.form.dueDate'), t('finances.form.paymentDate')
        ]],
        body: rows.map(r => [
            ...
            fmtDate(r.due_date), fmtDate(r.payment_date),
        ]),
